...
const PILLARS = [
  { id: "energy-recovery", name: "Energy & Recovery", score: 78, zone: "green", trend: "+3", icon: Zap, color: "text-success", bg: "bg-success/10" },
  { id: "organs-inflammation", name: "Organs & Inflammation", score: 62, zone: "amber", trend: "-2", icon: Heart, color: "text-warning", bg: "bg-warning/10" },
  { id: "stress-nervous", name: "Stress & Nervous System", score: 71, zone: "amber", trend: "+5", icon: Brain, color: "text-warning", bg: "bg-warning/10" },
  { id: "metabolic-cv", name: "Metabolic & CV", score: 55, zone: "amber", trend: "+1", icon: Gauge, color: "text-warning", bg: "bg-warning/10" },
];
